    ...
    <div className="flex min-h-screen flex-col justify-center bg-gradient-to-b from-background to-background/95 px-4 py-12">
      <div className="mx-auto w-full max-w-lg space-y-8">
        <div className="text-center space-y-2">
          ...
          <p className="text-sm text-muted-foreground">Enter your credentials to open the dashboard.</p>
        </div>
        ...
        <Card>
          <CardHeader className="space-y-3">
            ...
            <CardDescription>We keep you signed in securely on this device.</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <p className="text-center text-sm text-muted-foreground">
          New here?{' '}
          <Link to="/register" className="font-semibold text-primary hover:text-primary-fuchsia">
            Create an account
          </Link>
        </p>
      </div>
